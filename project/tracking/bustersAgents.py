...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for action in legal:
            ...
            if self.distancer.getDistance(successorPosition, best_pos) < best_dist:
                best_dist = self.distancer.getDistance(successorPosition, best_pos)
                best_action = action
        return best_action
